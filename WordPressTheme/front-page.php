<?php get_header(); ?>
  ...
  <div class="l-mv p-mv js-mv">
    <picture class="p-mv__img">
      <source srcset="<?php echo get_template_directory_uri() ?>/assets/img/common/img_top-pc.jpg" media="(min-width: 768px)"  type="image/jpg" />
...
<div class="l-top-bgGray">
  <div class="l-top-bgGray__inner">
    <section class="l-top-box1 p-box1">
      <div class="p-box1__inner">
        <div class="p-box1-content">
  ...
  <div class="l-inner">
    ...
    <div class="p-topics__items">
      <div class=">p-topics__item p-topic-info">
        ...
        <a class="p-topic-info__text">イベントレポート「VRクリエイター座談会 〜5Gの次に来るもの〜」</a>
      </div>

      <div class=">p-topics__item p-topic-info">
        <time datetime="<?php the_time('c');?>" class="p-topic-info__date">2020.02.01</time>
        <a class="p-topic-info__text">プレスリリースのお知らせ DIGGIN’ RECORDS</a>
      </div>

      <div class=">p-topics__item p-topic-info">
        <time datetime="<?php the_time('c');?>" class="p-topic-info__date">2020.02.01</time>
        <a class="p-topic-info__text">新年明けましておめでとうございます</a>
      </div>
    </div>
