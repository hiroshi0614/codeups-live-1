...
<div class="l-mv p-sub-mv js-sub-mv">
  <picture class="p-sub-mv__img">
    <source srcset="<?php echo get_template_directory_uri() ?>/assets/img/contact/img_contact-pc.jpg" media="(min-width: 768px)"  type="image/jpg" />
    <img src="<?php echo get_template_directory_uri() ?>/assets/img/contact/img_contact-sp.jpg" alt="">
  </picture>
    ...
    <div class="p-sub-contact__contents">
      <div class="p-sub-contact__content">
        <div class="p-sub-contact__head">
          <p class="p-sub-contact__title">お問合せ種別</p>
          <span class="p-sub-contact__required">必須</span>
        </div>
        <div class="p-sub-contact__item p-contact-radio">
          <label>
            <input class="p-contact-radio__item" type="radio" name="radio-name">
            <span>制作依頼</span>
          </label>
          <label>
            <input class="p-contact-radio__item" type="radio" name="radio-name">
